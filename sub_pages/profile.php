	...
	<body class="<?php echo $page_name; ?>">
		...
		<div class="side-menu">
			...
			<div class="content-container">
				<section class="menu">
					<ul class="ul-menu">
                        <li class="selected-page">Profile</li>
                        <li><a href="../gallery.php">Gallery</a></li>
                        <li><a href="../index.php">Home</a></li>
                        <li><a href="../posts.php">Posts</a></li>
						<li><a href="add-post.php">Post something</a></li>							
					</ul>
				</section>
                ...
                <div class="profile-container">
					<div class="profile-box">
						...
						<div class="info-container">
							<div class="edit-profile"><a href="edit-profile.php"><i class="fas fa-user-edit"></i></a></div>
							<div class="box box-1">
								...
								<div class="input-box">
									...
									<?php 
										if($info['first_name'] == 'empty' && $info['last_name'] == 'empty'){
											echo '<div>empty</div>';
										} else echo '<div>'.$info['first_name'].' '.$info['last_name'].'</div>';
									?>
								</div>

								<div class="input-box">
									<span>Location</span>
									<div><?php echo $info['location'] ?></div>
								</div>
								...
								<div class="input-box">
									<span>Age</span>
									<div><?php echo $info['age'] ?></div>
								</div>

								<div class="input-box">
									<span>Degree</span>
									<div><?php echo $info['degree'] ?></div>
								</div>
