		...
		<div class="wrapper">
			...
			<div class="main">
                ...
                <div class="form-container">
                    ...
                    <form id="add-form" action="../_inc/new-post.php" method="post" enctype="multipart/form-data">
                        ...
                        <input name="user_name" type="hidden" value="<?php echo $info['first_name'].' '.$info['last_name']?>">
